    ...
    <Section>
     ...
     <div className="collapse-content">
      <ul className="list-disc px-4">
       ...
       <li className="leading-8">Memorized the the <em>Declaration of Independence</em> in one hundred days (&apos;16)</li>
      </ul>
     </div>
    </div>
    <div className="collapse collapse-arrow bg-base-200">
     <input type="radio" name="accordion" />
     <div className="collapse-title text-xl font-medium">Adroit as a Performer</div>
     <div className="collapse-content">
      <ul className="list-disc px-4">
       ...
       <li className="leading-8">Officiated hundreds upon hundreds of weddings, mostly in the Dallas area</li>
       <li className="leading-8">At age 74, he was filmed reciting the <em>Declaration of Independence</em> in a studio for the Freedom Encounter organization and its show Freedom Journey in Branson, MO</li>
      </ul>
     </div>
    </div>
    <div className="collapse collapse-arrow bg-base-200">
    ...
    <div className="collapse collapse-arrow bg-base-200">
     ...
     <div className="collapse-content">
      <ul className="list-disc px-4">
       ...
       <li className="leading-8">Assistant Pastor/Pastor of Lakeview Congregation, located at a retirement home, Dallas (&apos;09-14)</li>
      </ul>
     </div>
    </div>
    </Section>
